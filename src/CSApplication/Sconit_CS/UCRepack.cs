...
namespace Sconit_CS
{
    public partial class UCRepack : UserControl
    {
        ...
        private void InitialAll()
        {
            ...
            this.resolver.UserCode = this.user.Code;
            this.resolver.ModuleType = BusinessConstants.TRANSFORMER_MODULE_TYPE_REPACK;
        }
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            else if (this.btnRepack.Focused)
            {
                if (keyData == Keys.Enter)
                {
