...
namespace Sconit_CS
{
    public static class BusinessConstants
    {
        ...
        public static readonly string PRINT_ORDER_TYPE_PURCHASE = "Purchase";
        public static readonly string PRINT_ORDER_TYPE_PRODUCTION = "Production";
        public static readonly string PRINT_ORDER_TYPE_INSPECT = "Inspect";
        public static readonly string PRINT_ORDER_TYPE_PICKLIST = "Picklist";
        public static readonly string PRINT_ORDER_TYPE_ASN = "ASN";
        public static readonly string PRINT_ORDER_TYPE_RECEIPT = "Receipt";
        public static readonly string PRINT_ORDER_TYPE_ORDER = "Order";
        ...
        public static readonly string TRANSFORMER_MODULE_TYPE_PRINTING = "Module_Printing";
        public static readonly string TRANSFORMER_MODULE_TYPE_SEQUENCEONLINE = "Module_SequenceOnline";//排序上线
        public static readonly string TRANSFORMER_MODULE_TYPE_SEQUENCEOFFLINE = "Module_SequenceOffline";//排序下线
        ...
        public static readonly string TRANSFORMER_MODULE_TYPE_OFFLINE_FORCE = "Module_Offline_Force";
        //百利得客户化,把拣货发货和订单发货分开
