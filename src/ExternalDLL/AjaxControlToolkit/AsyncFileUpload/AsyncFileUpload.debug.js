...
AjaxControlToolkit.AsyncFileUpload = function(element) {
    AjaxControlToolkit.AsyncFileUpload.initializeBase(this, [element]);
...
AjaxControlToolkit.AsyncFileUpload.prototype = {
    ...
    _onStart: function(fileName) {
        var valid = this.raiseUploadStarted(new AjaxControlToolkit.AsyncFileUploadEventArgs(fileName, null, null, null));
    ...
    initialize: function() {
        AjaxControlToolkit.AsyncFileUpload.callBaseMethod(this, "initialize");
    ...
    dispose: function() {
        ...
        this._removeIframe();
        AjaxControlToolkit.AsyncFileUpload.callBaseMethod(this, "dispose");
    },
    ...
    _onError: function(error) {
        var unhandledException = AjaxControlToolkit.Resources.AsyncFileUpload_UnhandledException;
        this.setThrobber(false);
        ...
        if (!this.raiseUploadError(new AjaxControlToolkit.AsyncFileUploadEventArgs(this._inputFile.value, null, null, error))) {
    ...
    _onchange: function(e) {
        ...
        try {
            if (this._iframe == null) {
                ...
                this._removeIframe();
                var internalErrorMessage = AjaxControlToolkit.Resources.AsyncFileUpload_InternalErrorMessage;
    ...
    _stopLoad: function(result) {
        ...
        this.raiseUploadComplete(new AjaxControlToolkit.AsyncFileUploadEventArgs(this._inputFile.value, length, contentType, null));
    },
    ...
    _onload: function(e) {
        ...
        try {
            ...
            if (frameDocument == null || frameDocument.location == null) {
                var e = { "message": AjaxControlToolkit.Resources.AsyncFileUpload_UploadingProblem };
                throw (e);
...
//                }
                ...
                if (result != null) {
                    ...
                    var serverError = AjaxControlToolkit.Resources.AsyncFileUpload_UnknownServerError;
                    function replace_func(p0, p1) {
                        serverError = p1;
                        return "";
                    }
                    frameDocument.body.innerHTML.replace(/Exception\]:([^\n\r]+)[\n\r]/, replace_func);
                    var exMessage = AjaxControlToolkit.Resources.AsyncFileUpload_ServerResponseError + ": '" + serverError + "'";
                    var ret = confirm(exMessage + "\n\n" + AjaxControlToolkit.Resources.AsyncFileUpload_ConfirmToSeeErrorPage);
                    if (ret) {
    ...
    _wait: function() {
        ...
        try {
            ...
            setTimeout(function() { uploader._removeIframe(); }, 100);
            setTimeout(function() { uploader._onError(AjaxControlToolkit.Resources.AsyncFileUpload_UploadingProblem); }, 0);
            this._waitTimer = null;
        }
    }
}

AjaxControlToolkit.AsyncFileUpload.registerClass("AjaxControlToolkit.AsyncFileUpload", AjaxControlToolkit.ControlBase);

AjaxControlToolkit.AsyncFileUploadEventArgs = function(fileName, length, contentType, errorMessage) {
    if (arguments.length != 4) throw Error.parameterCount();

    //Calling the base class constructor
    AjaxControlToolkit.AsyncFileUploadEventArgs.initializeBase(this);
...
AjaxControlToolkit.AsyncFileUploadEventArgs.prototype =
{
...
AjaxControlToolkit.AsyncFileUploadEventArgs.registerClass('AjaxControlToolkit.AsyncFileUploadEventArgs', Sys.EventArgs);