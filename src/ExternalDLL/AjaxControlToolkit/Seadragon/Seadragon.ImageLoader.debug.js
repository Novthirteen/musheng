...
AjaxControlToolkit.Seadragon.Job = function(src, callback) {
    this._image = null;
    this._timeout = null;
    this._src = src;
...
AjaxControlToolkit.Seadragon.Job.prototype = {
...
AjaxControlToolkit.Seadragon.Job.registerClass('AjaxControlToolkit.Seadragon.Job', null, Sys.IDisposable);


AjaxControlToolkit.Seadragon.ImageLoader = function(imageLoaderLimit) {
	this._downloading = 0;
...
AjaxControlToolkit.Seadragon.ImageLoader.prototype = {
    ...
    loadImage: function(src, callback) {
        ...
        var job = new AjaxControlToolkit.Seadragon.Job(src, func);
...
AjaxControlToolkit.Seadragon.ImageLoader.registerClass('AjaxControlToolkit.Seadragon.ImageLoader', null, Sys.IDisposable);
