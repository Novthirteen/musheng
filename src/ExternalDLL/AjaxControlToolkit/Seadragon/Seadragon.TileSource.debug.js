...
AjaxControlToolkit.Seadragon.TileSource = function(width, height, tileSize, tileOverlap, minLevel, maxLevel) {
    this.aspectRatio = width / height;
    this.dimensions = new AjaxControlToolkit.Seadragon.Point(width, height);
...
AjaxControlToolkit.Seadragon.TileSource.prototype = {
    ...
    getNumTiles: function(level) {
        ...
        return new AjaxControlToolkit.Seadragon.Point(x, y);
    },
    ...
    getPixelRatio: function(level) {
        ...
        return new AjaxControlToolkit.Seadragon.Point(rx, ry);
    },
    ...
    getTileAtPoint: function(level, point) {
        ...
        return new AjaxControlToolkit.Seadragon.Point(tx, ty);
    },
    ...
    getTileBounds: function(level, x, y) {
        ...
        return new AjaxControlToolkit.Seadragon.Rect(px * scale, py * scale, sx * scale, sy * scale);
    },
...
AjaxControlToolkit.Seadragon.TileSource.registerClass('AjaxControlToolkit.Seadragon.TileSource', null, Sys.IDisposable);
