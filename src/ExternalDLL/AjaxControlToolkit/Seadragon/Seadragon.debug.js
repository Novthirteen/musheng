...
AjaxControlToolkit.Seadragon.ControlAnchor = function() {
    throw Error.invalidOperation();
}
AjaxControlToolkit.Seadragon.ControlAnchor.prototype = {
    NONE: 0,
    TOP_LEFT: 1,
    TOP_RIGHT: 2,
    BOTTOM_RIGHT: 3,
...
AjaxControlToolkit.Seadragon.ControlAnchor.registerEnum("AjaxControlToolkit.Seadragon.ControlAnchor", false);

Seadragon.ControlAnchor = AjaxControlToolkit.Seadragon.ControlAnchor;

AjaxControlToolkit.Seadragon.OverlayPlacement = function() {
    throw Error.invalidOperation();
}
AjaxControlToolkit.Seadragon.OverlayPlacement.prototype = {
    CENTER: 0,
    TOP_LEFT: 1,
    TOP: 2,
    TOP_RIGHT: 3,
...
AjaxControlToolkit.Seadragon.OverlayPlacement.registerEnum("AjaxControlToolkit.Seadragon.OverlayPlacement", false);
Seadragon.OverlayPlacement = AjaxControlToolkit.Seadragon.OverlayPlacement;

AjaxControlToolkit.Seadragon.NavControl = function(viewer) {
    this._group = null;
...
AjaxControlToolkit.Seadragon.NavControl.prototype = {
    initialize: function() {
        ...
        var zoomIn = $create(AjaxControlToolkit.Seadragon.Button,
        ...
        var zoomOut = $create(AjaxControlToolkit.Seadragon.Button,
        ...
        var goHome = $create(AjaxControlToolkit.Seadragon.Button,
        ...
        var fullPage = $create(AjaxControlToolkit.Seadragon.Button,
        ...
        this._group = $create(AjaxControlToolkit.Seadragon.ButtonGroup,
    ...
    _beginZoomingOut: function() {
        ...
        this._zoomFactor = 1.0 / this._zoomFactor;
        this._zooming = true;
        this._scheduleZoom();
    },
...
AjaxControlToolkit.Seadragon.NavControl.registerClass('AjaxControlToolkit.Seadragon.NavControl', null, Sys.IDisposable);

AjaxControlToolkit.Seadragon.Control = function(elmt, anchor, container) {
    // Properties
    this.elmt = elmt;
    this.anchor = anchor;
...
AjaxControlToolkit.Seadragon.Control.prototype = {
    initialize: function() {
        this.wrapper = Seadragon.Utils.makeNeutralElement("span");
        // Constructor
...
AjaxControlToolkit.Seadragon.Control.registerClass('AjaxControlToolkit.Seadragon.Control', null, Sys.IDisposable);

AjaxControlToolkit.Seadragon.Viewer = function(element) {
    AjaxControlToolkit.Seadragon.Viewer.initializeBase(this, [element]);
    //Fields

    this.config = new AjaxControlToolkit.Seadragon.Config();
...
AjaxControlToolkit.Seadragon.Viewer.prototype = {
    initialize: function() {
        AjaxControlToolkit.Seadragon.Viewer.callBaseMethod(this, 'initialize');
        ...
        this._fsBoundsDelta = new AjaxControlToolkit.Seadragon.Point(1, 1);
        ...
        if (this.get_showNavigationControl()) {
            navControl = (new AjaxControlToolkit.Seadragon.NavControl(this)).elmt;
            navControl.style.marginRight = "4px";
            navControl.style.marginBottom = "4px";
            this.addControl(navControl, AjaxControlToolkit.Seadragon.ControlAnchor.BOTTOM_RIGHT);
        }
    ...
    _onOpen: function(time, _source, error) {
        ...
        // assign fields
        this.source = _source;
        this.viewport = new AjaxControlToolkit.Seadragon.Viewport(this._prevContainerSize, this.source.dimensions, this.config);
        this.drawer = new AjaxControlToolkit.Seadragon.Drawer(this.source, this.viewport, this._canvas);
        this.profiler = new AjaxControlToolkit.Seadragon.Profiler();
        ...
        for (var i = 0; i < this._overlayControls.length; i++) {
            ...
            if (overlay.point != null) {
                this.drawer.addOverlay(overlay.id, new AjaxControlToolkit.Seadragon.Point(overlay.point.X, overlay.point.Y), AjaxControlToolkit.Seadragon.OverlayPlacement.TOP_LEFT);
            }
            else {
                this.drawer.addOverlay(overlay.id, new AjaxControlToolkit.Seadragon.Rect(overlay.rect.Point.X, overlay.rect.Point.Y, overlay.rect.Width, overlay.rect.Height), overlay.placement);
            }
        }
    ...
    addControl: function(elmt, anchor) {
        ...
        switch (anchor) {
            case AjaxControlToolkit.Seadragon.ControlAnchor.TOP_RIGHT:
                div = this._controlsTR;
                elmt.style.position = "relative";
                break;
            case AjaxControlToolkit.Seadragon.ControlAnchor.BOTTOM_RIGHT:
                div = this._controlsBR;
                elmt.style.position = "relative";
                break;
            case AjaxControlToolkit.Seadragon.ControlAnchor.BOTTOM_LEFT:
                div = this._controlsBL;
                elmt.style.position = "relative";
                break;
            case AjaxControlToolkit.Seadragon.ControlAnchor.TOP_LEFT:
                div = this._controlsTL;
                elmt.style.position = "relative";
                break;
            case AjaxControlToolkit.Seadragon.ControlAnchor.NONE:
            default:
                div = this._container;
        ...
        this._controls.push(new AjaxControlToolkit.Seadragon.Control(elmt, anchor, div));
    },
    isOpen: function() {
        return !!this.source;
    },
    openDzi: function(xmlUrl, xmlString) {
        ...
        AjaxControlToolkit.Seadragon.DziTileSourceHelper.createFromXml(xmlUrl, xmlString,
    ...
    setFullPage: function(fullPage) {
        ...
        if (this.viewport) {
            ...
            if (fullPage) {
                ...
                this._fsBoundsDelta = new AjaxControlToolkit.Seadragon.Point(newBounds.width / oldBounds.width,
...
AjaxControlToolkit.Seadragon.Viewer.registerClass('AjaxControlToolkit.Seadragon.Viewer', Sys.UI.Control);
