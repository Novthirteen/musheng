                ...
                if (this._autoClose) {
                    ...
                    setTimeout(function() {
                        if (button._forclose_onmousedown$delegate != null) {
                            ...
                            AjaxControlToolkit.HTMLEditor._addEvent(window, "keydown", button._forclose_onmousedown$delegate);
    ...
    _forclose_onmousedown: function(e) {
        ...
        if (this._autoClose) {
            try {
                ...
                AjaxControlToolkit.HTMLEditor._removeEvent(window, "keydown", this._forclose_onmousedown$delegate);
