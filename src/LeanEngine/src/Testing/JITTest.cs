...
namespace Testing
{
    ...
    public class JITTest
    {
        ...
        //    DemandChain demandChain1 = new DemandChain();
        //    demandChain1.Locs = new List<string>();
        //    demandChain1.Locs.Add(locTo);
        //    demandChain1.FlowCode = flow.Code;
        //    demandChain1.ID = 1;
        //    demandChain1.Code = code;
        //    demandChains.Add(demandChain1);
        //    DemandChain demandChain2 = new DemandChain();
        //    demandChain2.Locs = new List<string>();
        //    demandChain2.Locs.Add(locTo);
        //    demandChain2.FlowCode = code;
        //    demandChain2.ID = 2;
