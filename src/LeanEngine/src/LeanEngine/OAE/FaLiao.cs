...
namespace LeanEngine.OAE
{
    ...
    /// Just In Time
    /// </summary>
    public class FaLiao : OAEBase
    {
        public FaLiao(List<Plans> Plans, List<InvBalance> InvBalances, List<DemandChain> DemandChains)
        ...
        protected override decimal GetReqQty(ItemFlow itemFlow)
        {
            ...
            foreach (var loc in itemFlow.DemandSources)
            {
                ...
                var orderIsss = this.GetOrderIss(loc, item, null, winTime);
