<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Edit.ascx.cs" Inherits="Warehouse_PutAway_Edit" %>
...
<fieldset>
    <asp:UpdatePanel ID="UP_GV_List" runat="server">
        <ContentTemplate>
            <legend>
                <asp:Literal ID="ltlBin" runat="server"></asp:Literal></legend>
    ...
    <div class="tablefooter">
        <asp:Button ID="btnPutAway" runat="server" Text="<%$Resources:Language,PutAway%>"
            OnClick="btnPutAway_Click" CssClass="button2" />
    </div>
</fieldset>
