...
<fieldset>
    <table class="mtable">
        ...
        <tr>
            ...
            <td class="td02">
                <uc3:textbox ID="tbItemCode" runat="server" Visible="true" DescField="Description"
                    ...
                    OnTextChanged="tbItem_TextChanged" onclick="if(!readOnly)select();" onkeydown="KeyEnter();" />
        ...
        <tr>
            ...
            <td class="td02">
                <asp:TextBox ID="tbItemUnitCount" runat="server" onkeydown="KeyEnter();"></asp:TextBox>
            ...
            <td class="td02">
                <asp:TextBox ID="tbHuLotSize" runat="server" onkeydown="KeyEnter();"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="td02">
                <asp:TextBox ID="tbManufactureDate" runat="server" CssClass="inputRequired" onmouseup="if(!readOnly)select();"
                    onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" onkeydown="KeyEnter();"></asp:TextBox>
            ...
            <td class="td02">
                <asp:TextBox ID="tbSupplierLotNo" runat="server" CssClass="inputRequired" onmouseup="if(!readOnly)select();" onkeydown="KeyEnter();"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="td02">
                <asp:TextBox ID="tbPapers" runat="server" onmouseup="if(!readOnly)select();" CssClass="inputRequired" onkeydown="KeyEnter();"></asp:TextBox>
            ...
            <td class="td02">
                <asp:TextBox ID="tbCopies" Text="1" runat="server" onmouseup="if(!readOnly)select();" onkeydown="KeyEnter();"
