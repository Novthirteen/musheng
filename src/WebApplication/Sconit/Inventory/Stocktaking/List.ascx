<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Inventory_Stocktaking_List" %>
...
<fieldset>
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Code"
            ...
            DefaultSortExpression="Code" DefaultSortDirection="Descending" OnRowDataBound="GV_List_RowDataBound">
            <Columns>
                ...
                <asp:TemplateField HeaderText="${Common.Business.PhyCntGroupBy}" SortExpression="Type">
                    <ItemTemplate>
                        <cc1:CodeMstrLabel ID="lblPhyCntGroupBy" Code="PhyCntGroupBy" runat="server" Value='<%#Bind("PhyCntGroupBy") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
