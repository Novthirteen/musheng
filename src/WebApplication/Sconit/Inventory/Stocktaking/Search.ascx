<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Search.ascx.cs" Inherits="Inventory_Stocktaking_Search" %>
...
<fieldset>
    <table class="mtable">
        ...
        <tr>
            ...
            <td class="td02">
                <sc1:CodeMstrDropDownList ID="ddlType" runat="server" Code="PhysicalCountType" IncludeBlankOption="true" />
            </td>
            <td class="td01">
                <asp:Literal ID="lblPhyCntGroupBy" runat="server" Text="${Common.Business.PhyCntGroupBy}:" />
            </td>
            <td class="td02">
                <sc1:CodeMstrDropDownList ID="ddlPhyCntGroupBy" runat="server" Code="PhyCntGroupBy"
