<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Main.ascx.cs" Inherits="Reports_InvIOBParty_Main" %>
        ...
        <tr>
            ...
            <td class="td02">
                <uc3:textbox ID="tbFlow" runat="server" Visible="true" DescField="Description" ValueField="Code"
                    ServiceMethod="GetFlowListForMushengRequirePurOnly" ServicePath="FlowMgr.service" Width="250" />
            </td>
            <td class="td01">
            ...
            <td class="td02">
                <uc3:textbox ID="tbLocaion" runat="server" Visible="true" DescField="Name" ValueField="Code"
                    ServiceMethod="GetLocationListForMushengRequireForSup" ServicePath="LocationMgr.service" Width="250" /> 
            </td>
        </tr>
        <tr>
            <td class="td01">
