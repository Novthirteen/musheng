<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Reports_ShiftProd_List" %>
        ...
        <sc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ScrapQty" HeaderText="${MasterData.Order.LocTrans.AccumulateRejectQty.Production}"
                 ...
                 <asp:BoundField DataField="NumField1" HeaderText="${MasterData.Order.OrderDetail.MeterQty}"
                    SortExpression="NumField1" DataFormatString="{0:0.########}" />
                <asp:TemplateField HeaderText="${Reports.ShiftProd.PercentComplete}">
                    <ItemTemplate>
                        <asp:Label ID="lblCompleteRate" runat="server" Text='<%# Eval("CompleteRate","{0:P}")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
