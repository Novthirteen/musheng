<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Search.ascx.cs" Inherits="Reports_ShiftProd_Search" %>
...
<fieldset>
    <table class="mtable">
        ...
        <tr>
            ...
            <td class="td02">
                <asp:CheckBox ID="cbClassifiedFlow" runat="server" Text="${Common.Business.ProductionLine}" />
                <asp:CheckBox ID="cbClassifiedParty" runat="server" Text="${Common.Business.Region}" />
                <asp:CheckBox ID="cbClassifiedShift" runat="server" Text="${MasterData.WorkCalendar.Shift}" />
                <asp:CheckBox ID="cbClassifiedDate" runat="server" Text="${Common.Business.Date}" />
            </td>
            <td class="td01">
            </td>
            <td class="t02">
