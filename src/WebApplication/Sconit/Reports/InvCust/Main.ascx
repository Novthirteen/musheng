<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Main.ascx.cs" Inherits="Reports_InvCust_Main" %>
        ...
        <tr>
            ...
            <td class="td02">              
              <uc3:textbox ID="tbFlow" runat="server" Visible="true" DescField="Description" ValueField="Code"
                    ServiceMethod="GetFlowListForMushengRequireCustOnly" ServicePath="FlowMgr.service" Width="250" />            </td>
            <td class="td01">
