    ...
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Code"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${MasterData.Flow.Party.From.Customer}" SortExpression="PartyFrom">
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "PartyFrom.Name")%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${MasterData.Flow.Party.To.Region}" SortExpression="PartyTo">
                    <ItemTemplate>
                ...
                <asp:BoundField DataField="FlowStrategy" SortExpression="FlowStrategy" HeaderStyle-Wrap="false"
                    HeaderText="${MasterData.Flow.Strategy.CustomerGoods}" />
