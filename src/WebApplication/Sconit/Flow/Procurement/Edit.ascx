            ...
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        ...
                        <td class="td02">
                            <uc3:textbox ID="tbBillAddress" runat="server" Visible="true" DescField="Address"
                                ValueField="Code" ServiceParameter="string:#tbPartyFrom" Width="250" ServicePath="AddressMgr.service"
