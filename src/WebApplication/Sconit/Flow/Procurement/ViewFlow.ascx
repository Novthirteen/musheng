            ...
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        ...
                        <td class="td02">
                            <sc1:ReadonlyTextBox ID="tbShipFrom" runat="server" CodeField="ShipFrom.Code" DescField="BillAddress.Address" />
                        </td>
                        <td class="td01">
                            <asp:Literal ID="lblShipTo" runat="server" Text="${MasterData.Flow.Ship.To}:" />
                        </td>
                        <td class="td02">
                            <sc1:ReadonlyTextBox ID="tbShipTo" runat="server" CodeField="ShipFrom.Code" DescField="BillAddress.Address" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td01">
            ...
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        ...
                        <td class="ttd02">
                            <asp:CheckBox ID="cbIsAsnUniqueReceipt" runat="server" Checked='<%# Bind("IsAsnUniqueReceipt") %>' Enabled="false">
                            </asp:CheckBox>
                        </td>
                        <td class="ttd01">
