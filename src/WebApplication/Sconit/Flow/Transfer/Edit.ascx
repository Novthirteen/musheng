                ...
                <table class="mtable">
                    <tr>
                        ...
                        <td class="td02">
                            ...
                            <asp:CustomValidator ID="cvLoc" runat="server" ControlToValidate="tbLocFrom" ErrorMessage="${MasterData.Flow.Location.Equal}"
                                Display="Dynamic" ValidationGroup="vgSave" OnServerValidate="checkLocation" />
