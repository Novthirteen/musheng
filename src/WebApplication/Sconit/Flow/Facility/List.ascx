<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="MasterData_Facility_List" %>
...
<fieldset>
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Code"
            ...
            <Columns>
                <asp:BoundField DataField="Code" HeaderText="${MasterData.Flow.Facility.Code}" SortExpression="Code" />
                <asp:TemplateField HeaderText="${Menu.MasterData.Routing}">
                    <ItemTemplate>
