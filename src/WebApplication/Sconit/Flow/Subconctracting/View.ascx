...
<fieldset>
    <legend>${MasterData.Flow.Flow.Subconctracting}</legend>
...
<fieldset id="fdDetail" runat="server" visible="false">
    <legend>${MasterData.Flow.Detail.Subconctracting}</legend>
...
<fieldset id="fdRouting" runat="server" visible="false">
    <legend>${MasterData.Flow.Routing.Subconctracting}</legend>
