...
<fieldset>
    <table class="mtable">
        <tr>
            <td class="ttd01">
                <asp:Literal ID="lblFlow" runat="server"  Text="${MasterData.Flow.Flow.Subconctracting}:"/>
            </td>
            <td class="ttd02">
                <uc3:textbox ID="tbFlow" runat="server" Visible="true" DescField="Description" ValueField="Code" Width="250"
                    ServicePath="FlowMgr.service" ServiceMethod="GetSubconctractingFlow" />
            </td>
            <td class="ttd01">
                <asp:Literal ID="lblStrategy" runat="server" Text="${MasterData.Flow.Strategy.Subconctracting}:" />
            </td>
            <td class="ttd02">
