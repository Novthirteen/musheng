    ...
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Code"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${MasterData.Flow.Party.From.Region}" SortExpression="PartyFrom">
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "PartyFrom.Name")%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${MasterData.Flow.Location.From.Production}" SortExpression="LocationFrom">
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "LocationFrom.Name")%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${MasterData.Flow.Location.To.Production}" SortExpression="LocationTo">
                    <ItemTemplate>
                ...
                <asp:BoundField DataField="FlowStrategy" SortExpression="FlowStrategy" HeaderStyle-Wrap="false"
                    HeaderText="${MasterData.Flow.Strategy.Production}" />
