<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="MasterData_Customer_List" %>
...
<fieldset>
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Code"
            ...
            <Columns>
                <asp:BoundField DataField="Code" HeaderText="${MasterData.Customer.Code}" SortExpression="Code" />
                <asp:BoundField DataField="Name" HeaderText="${MasterData.Customer.Name}" SortExpression="Name" />
                 <asp:BoundField DataField="Aging" HeaderText="${MasterData.Supplier.Aging}" SortExpression="Aging" />
                <asp:CheckBoxField DataField="IsActive" HeaderText="${MasterData.Customer.IsActive}"
