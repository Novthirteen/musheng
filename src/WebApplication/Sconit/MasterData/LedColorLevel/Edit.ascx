<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Edit.ascx.cs" Inherits="MasterData_LedColorLevel_Edit" %>
<%@ Register Src="~/Controls/TextBox.ascx" TagName="textbox" TagPrefix="uc3" %>
<div id="divFV" runat="server">
    <asp:FormView ID="FV_LedColorLevel" runat="server" DataSourceID="ODS_LedColorLevel"
        DefaultMode="Edit" Width="100%" DataKeyNames="Id" OnDataBound="FV_LedColorLevel_DataBound">
        <EditItemTemplate>
            <fieldset>
                <legend>${MasterData.LedColorLevel.UpdateLedColorLevel}</legend>
                <table class="mtable">
                    <tr>
                        <td class="ttd01">
...
<asp:ObjectDataSource ID="ODS_LedColorLevel" runat="server" TypeName="com.Sconit.Web.LedColorLevelMgrProxy"
    DataObjectTypeName="com.Sconit.Entity.Customize.LedColorLevel" UpdateMethod="UpdateLedColorLevel"
    OnUpdated="ODS_LedColorLevel_Updated" OnUpdating="ODS_LedColorLevel_Updating" DeleteMethod="DeleteLedColorLevel"
    OnDeleted="ODS_LedColorLevel_Deleted" SelectMethod="LoadLedColorLevel">
    <SelectParameters>
