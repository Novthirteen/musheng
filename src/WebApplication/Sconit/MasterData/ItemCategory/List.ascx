<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="MasterData_ItemCategory_List" %>
...
<fieldset>
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Code"
            ...
            <Columns>
                <asp:BoundField DataField="Code" HeaderText="${MasterData.ItemCategory.Code}" SortExpression="Code" />
                <asp:BoundField DataField="Description" HeaderText="${Common.Business.Description}" SortExpression="Description" />
                <asp:TemplateField HeaderText="${MasterData.ItemCategory.ParentCategory}" SortExpression="ParentCategory.Code">
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "ParentCategory.Code")%>
                    </ItemTemplate>
                </asp:TemplateField>
