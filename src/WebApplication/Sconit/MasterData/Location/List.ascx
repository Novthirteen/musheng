    ...
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Code"
            ...
            <Columns>
                ...
                <asp:CheckBoxField DataField="IsMRP" HeaderText="${MasterData.Location.IsMRP}"
                    SortExpression="IsMRP" />
                <asp:TemplateField HeaderText="${MasterData.Location.Type}" SortExpression="Type">
                    <ItemTemplate>
                        <cc1:CodeMstrLabel ID="ddlType" Code="LocationType" runat="server" Value='<%# Bind("Type") %>'>
                        </cc1:CodeMstrLabel>
                    </ItemTemplate>
                </asp:TemplateField>
