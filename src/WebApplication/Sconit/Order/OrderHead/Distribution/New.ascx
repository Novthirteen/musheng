...
<fieldset>
    <table class="mtable">
        ...
        <tr>
                    ...
                    <tr>
                        <td>
                            <asp:TextBox ID="tbWinTime" runat="server" Text='<%# Bind("WindowTime") %>' CssClass="inputRequired"
                                onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" TabIndex="-1" />
            ...
            <td class="td02">
                <asp:TextBox ID="tbExtOrderNo" runat="server" />
                <asp:RequiredFieldValidator ID="rfvExtOrderNo" runat="server" ErrorMessage="${MasterData.ReceiveOrder.RefNo.Empty}"
                    Display="Dynamic" ControlToValidate="tbExtOrderNo" ValidationGroup="vgCreate" />
            </td>
        </tr>
        <tr>
            <td class="td01">
