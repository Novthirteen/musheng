...
<fieldset>
        ...
        <EditItemTemplate>
            <table class="mtable">
                ...
                <%--<tr>
                    ...
                    <td class="td02">
                        <asp:CheckBox ID="cbNeedSortAndColor" runat="server" Checked='<%# Bind("NeedSortAndColor") %>' />
                    </td>
                </tr>--%>
                <tr>
                    <td class="td01">
    ...
    <div class="tablefooter">
        ...
        <sc1:Button ID="btnSubmit" runat="server" Text="${MasterData.Order.Button.Submit}"
            OnClientClick="return confirm('${Common.Button.Submit.Confirm}')" CssClass="button2"
            OnClick="btnSubmit_Click" FunctionId="SubmitOrder" Visible="false" />
        <sc1:Button ID="btnForceSubmit" runat="server" Text="${MasterData.Order.Button.ForceSubmit}"
            OnClientClick="return confirm('${Common.Button.ForceSubmit.Confirm}')" CssClass="button2"
            OnClick="btnForceSubmit_Click" FunctionId="ForceSubmitOrder" />
        <asp:Button ID="btnConfirm" runat="server" Text="${Common.Button.Confirm}" CssClass="button2"
            OnClientClick="return confirm('${Common.Button.Confirm.Confirm}')" OnClick="btnConfirm_Click"
            Visible="false" />
        ...
        <sc1:Button ID="btnReceive" runat="server" Text="${MasterData.Order.Button.Receive}"
            OnClientClick="return confirm('${Common.Button.Receive.Confirm}')" CssClass="button2"
            OnClick="btnReceive_Click" FunctionId="ReceiveOrder" />
        <sc1:Button ID="btnForceReceive" runat="server" Text="${MasterData.Order.Button.ForceReceive}"
            OnClientClick="return confirm('${Common.Button.ForceReceive.Confirm}')" CssClass="button2"
            OnClick="btnForceReceive_Click" FunctionId="ForceReceiveOrder" />
        <sc1:Button ID="btnComplete" runat="server" Text="${MasterData.Order.Button.Complete}"
            OnClientClick="return confirm('${Common.Button.Complete.Confirm}')" CssClass="button2"
            OnClick="btnComplete_Click" FunctionId="CompleteOrder" />
