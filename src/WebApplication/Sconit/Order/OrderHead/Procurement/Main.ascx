...
<%@ Register Src="~/Order/OrderHead/OrderImport/Main.ascx" TagName="Import" TagPrefix="uc2" %>
<%@ Register Src="../../NewOrder/List.ascx" TagName="NewOrder" TagPrefix="uc2" %>
<uc2:NewOrder ID="ucNewOrder" runat="server" Visible="false" />
