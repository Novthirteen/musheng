<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Import.ascx.cs" Inherits="Production_PLFeedSeq_Import_Import" %>
        ...
        <tr>
            ...
            <td class="td02">
                <asp:HyperLink ID="hlTemplate" runat="server" Text="${Common.Business.ClickToDownload}"
                    NavigateUrl="~/Reports/Templates/ExcelTemplates/ProdutLineFeedSeqenceSample.xls"></asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td colspan="3" />
