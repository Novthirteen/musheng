<%@ Control Language="C#" AutoEventWireup="true" CodeFile="New.ascx.cs" Inherits="Quote_Customer_New" %>
<fieldset>
    <table class="mtable">
        <tr>
            <td class="ttd01">
            ...
            <td class="ttd02">
                ...
                <asp:RequiredFieldValidator ID="rfvCode" runat="server" ControlToValidate="txtCustomerCode" ErrorMessage="不能为空" ValidationGroup="vgNew"></asp:RequiredFieldValidator>
            </td>
            <td class="ttd01">
        ...
        <tr>
            ...
            <td class="ttd02"></td>
            <td class="ttd01">
                <asp:Button ID="btnNew" runat="server" Text="${Common.Button.New}" OnClick="btnNew_Click" ValidationGroup="vgNew" />
            </td>
            <td class="ttd02">
