...
public partial class Quote_ProductInfo_New : NewModuleBase
{
    ...
    //void LoadCustomer()
    //{
    //    this.ddlCustomerName.DataSource = TheCustomerMgr.GetAllCustomer();
    ...
    public void btnNew_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtCustomer.Text.Trim() != string.Empty)
            {
                ...
                //productInfo.CustomerName = ddlCustomerName.SelectedItem.Text;
            }
            ...
            #endregion
            TheToolingMgr.CreatProductInfo(productInfo);
