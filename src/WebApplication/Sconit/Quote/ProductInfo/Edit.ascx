<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Edit.ascx.cs" Inherits="Quote_ProductInfo_Edit" %>
...
<fieldset>
    <table class="mtable">
        ...
        <tr>
            ...
            <td class="td01">
                <%--<asp:Literal ID="ltlPackPrice" runat="server" Text="${Quote.ProductInfo.PackPrice}:"></asp:Literal>--%>
            ...
            <td class="td02">
                <%--<asp:TextBox ID="txtPackPrice" runat="server" Enabled="false"></asp:TextBox>--%>
