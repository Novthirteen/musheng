<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProjectList.ascx.cs" Inherits="Quote_Quotes_ProjectList" %>
    ...
    <div class="GridView" id="divGroup">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${Quote.ProductInfo.VersionNo}">
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "PVision")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="${Common.GridView.Action}">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbtnEdit" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id") %>' Text="${Common.Button.Edit}" OnClick="lbtnEdit_Click"></asp:LinkButton>
