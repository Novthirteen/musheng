<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Cost_CostElement_List" %>
        ...
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Code"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Description" HeaderText="${Common.Business.Description}"
                 ...
                 <asp:TemplateField HeaderText="${Cost.CostElement.CostCategory}" SortExpression="LocationTo">
                    <ItemTemplate>
                       <cc1:CodeMstrLabel ID="ddlCategory" Code="CostCategory" runat="server" Value='<%# Bind("Category") %>'/>
                    </ItemTemplate>
                </asp:TemplateField>
