<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Cost_CostGroup_List" %>
    ...
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Code"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Code" HeaderText="${Cost.CostGroup.Code}" SortExpression="Code" />
                <asp:BoundField DataField="Description" HeaderText="${Cost.CostGroup.Description}" SortExpression="Description" />
