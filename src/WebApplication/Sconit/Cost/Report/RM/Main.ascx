...
<fieldset>
    <table class="mtable">
        <tr>
            ...
            <td class="td02">
                <asp:TextBox ID="tbfc" runat="server" onClick="WdatePicker({dateFmt:'yyyy-M'})"  CssClass="inputRequired" />
                 <asp:RequiredFieldValidator ID="rfvfc" runat="server" ErrorMessage="请选择会计年月"
                    Display="Dynamic" ControlToValidate="tbfc" ValidationGroup="vgSave" />
            </td>
            <td class="td01">
            </td>
            <td class="td02">
        ...
        <tr>
            ...
            <td class="td02">
                <asp:Button ID="btnSearch" runat="server" Text="${Common.Button.Search}" OnClick="btnSearch_Click" ValidationGroup="vgSave" />
                <asp:Button ID="btnExport" runat="server" Text="${Common.Button.Export}" OnClick="btnSearch_Click" ValidationGroup="vgSave" />
            </td>
        </tr>
    </table>
</fieldset>
