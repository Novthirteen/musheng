<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Main.ascx.cs" Inherits="Cost_Report_InvIOBnew_Main" %>
        ...
        <tr>
            ...
            <td class="td02">
                <uc3:textbox ID="tbLocation" runat="server" Visible="true" DescField="Name" Width="280"
                    ...
                    MustMatch="true" />
               <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="请选择库位"
                    Display="Dynamic" ControlToValidate="tbLocation" ValidationGroup="vgSave" />--%>
            </td>
            <td class="td01">
