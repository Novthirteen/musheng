<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Edit.ascx.cs" Inherits="Cost_CostAllocateTransaction_Edit" %>
...
<div id="divFV" runat="server">
    ...
    <table class="mtable">
        <tr>
            ...
            <td class="td02">
                <div class="buttons">
                    <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="${Common.Button.Save}"
