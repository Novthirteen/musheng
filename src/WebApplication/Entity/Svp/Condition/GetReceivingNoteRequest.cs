...
namespace com.Sconit.Entity.Svp.Condition
{
    ...
    public partial class GetReceivingNoteRequest
    {
        ...
        private List<EntityOrderby> orderbyField;
        ...
        public EntityOrderby[] orderby
        {
            get
            {
                ...
                {
                    return this.orderbyField.ToArray();
                }
                else
                {
                    return null;
            ...
            set
            {
                orderbyField = new List<EntityOrderby>();
                foreach (EntityOrderby o in orderby)
                {
                    orderbyField.Add(o);
                }
            }
        ...
        public void addOrderby(string field, bool asc)
        {
